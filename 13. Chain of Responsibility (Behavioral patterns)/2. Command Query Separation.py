...
so
Command is something that you send when you're asking for an action change (please set attack value to 2)
...
give me the contents of the field or you send a command that states please set the field to this particular value
